...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const expirationInMilliseconds = 10 * 60 * 1000; // 10 menit * 60 detik * 1000 milidetik
      ...
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.caption}>
            Stay healty and classy with GizNow!
          </Text>
              ...
              <View
                ...
                <TouchableOpacity onPress={togglePasswordVisibility}>
                  {passwordVisible ? (
                    ...
                    <EyeSlash variant="Linear" color="black" size={20} />
                  )}
                </TouchableOpacity>
              </View>
              <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center', marginTop: 15,}}>
        ...
        <View style={{gap: 10}}>
          <TouchableHighlight
            style={[
              button.container,
              {
                backgroundColor: isLoginDisabled ? '#004D47' : '#104A41',
              },
            ]}
            underlayColor="#4c827e"
            onPress={handleLogin}
